...
public class PacienteMedio extends Paciente{
    ...
    public PacienteMedio(int id_paciente, String nombre_paciente, String apellido_paciente, String carnet, String sintomas,String sexo, LocalDate fecha_nacimiento,String telefono,String direccion){
